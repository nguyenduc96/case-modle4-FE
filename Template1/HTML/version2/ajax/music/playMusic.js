...
function drawMusicPlayer(data) {
    ...
    $(".jp-now-playing").html(`<div class='jp-track-name'><span class='que_img'><img src='http://localhost:8080//${data.image}'></span><div class='que_data'>${data.name}<div class='jp-artist-name'>${data.user.fullName}</div></div></div>`);
